...
if add_selectbox == 'One-click Report':
    ...
    with bd:
        ...
        adf = pd.read_excel(r'https://github.com/maixbach/pythonproject_final_mxbach/blob/main/data/all_data.xlsx', sheet_name = "data")
        ...
        if name_country:
            ...
            country_codes = pd.read_excel(r'https://github.com/maixbach/pythonproject_final_mxbach/blob/main/data/all_data.xlsx', sheet_name='data', index_col= 'adb_code')
            
            # Read Excel file 
            policy_rate_annual = pd.read_excel(r'https://github.com/maixbach/pythonproject_final_mxbach/blob/main/data/quarterly_monthly_data.xlsx', sheet_name=country, header=8, index_col=0, usecols='AH:AI', parse_dates=['year']).dropna()
